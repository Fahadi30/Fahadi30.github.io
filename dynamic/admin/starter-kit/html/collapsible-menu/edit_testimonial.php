        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Edit Testimonial</h5>
        ...
        if ($_FILES['img_test']['size'] > 500000) {
            echo "Sorry, your image size is too large.";
                ...
                echo "Sorry, only JPG, JPEG, PNG files are allowed.";
                    ...
                    $query = "UPDATE `testimonial` SET `name`='".$name."',`city`='".$test_city."',`image`='".$img_test."',`country`='".$country_select."',msg = '".$description."' WHERE tes_id ='".$id."'";
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <h4 class="header2">Edit Testimonial</h4>
                    <div class="row">
                        <form class="col s12" action="#" method="post" enctype="multipart/form-data">
                           
                           <?php 
                            
                            $query = "Select * from testimonial where tes_id ='".$id."'";
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="test_name" name="test_name" type="text" value="<?php echo $row['name'];?>">
                                    <label for="test_name">Name</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s6" >
                                    <input id="test_city" name="test_city" type="text" value="<?php echo $row['city'];?>">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea id="description" name="description" class="materialize-textarea" length="120"><?php echo $row['msg'];?></textarea>
