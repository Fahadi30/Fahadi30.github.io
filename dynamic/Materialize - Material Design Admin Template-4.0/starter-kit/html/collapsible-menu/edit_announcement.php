        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Edit Announcement</h5>
        ...
        if ($_FILES['img_emp']['size'] > 500000) {
            echo "Sorry, your image size is too large.";
                ...
                echo "Sorry, only JPG, JPEG, PNG files are allowed.";
                    ...
                    $query = "UPDATE `announcements` SET `name`='".$name."',`discription`='".$description."',`image`='".$img_emp."',`link`='".$link_ann."' WHERE ann_id ='".$id."'";

                    if(mysqli_query($conn , $query)){
                        if(move_uploaded_file($_FILES['img_emp']['tmp_name'], $targetdir)){
                    ...
                    <div class="row">
                        <form class="col s12" action="#" method="post" enctype="multipart/form-data">
                           ...
                           <?php 
                            ...
                            $query = "Select * from announcements where ann_id ='".$id."'";
                            ...
                            <div class="row">
                                <div class="input-field col s6"><br>
                                    <input id="link_ann" name="link_ann" type="text" value="<?php echo $row['link'];?>">
