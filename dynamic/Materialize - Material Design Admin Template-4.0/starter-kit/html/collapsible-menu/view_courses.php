        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Veiw Courses</h5>
                    <ol class="breadcrumbs">
                        <li><a href="index.html">Dashboard</a>
                        </li>
                        <li class="active">Veiw Courses</li>
                    </ol>
                </div>
          ...
          <div class="container">
            ...
            <div id="tabs-in-card" class="section">
              <h4 class="header">Veiw Courses</h4>
                            ...
                            if($result->num_rows > 0){
                                while($row = $result->fetch_assoc()){
                                    echo "<div class='card-image'>";
                                                    echo "<img src='../../../../../education/education/images/courses/".$row['image']."' alt='sample'>";
                                                  ...
                                                  echo "<div class='card-action'>";
                                                    echo "<a href='edit_course.php?id=".$row['course_id']."'>Edit</a>";
